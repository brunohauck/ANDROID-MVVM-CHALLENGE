...
public class DetailsFragment extends BaseFragment {
    ...
    private void displayRepo() {
        detailsViewModel.getSelectedMovie().observe(this, repo -> {
            if (repo != null) {
                repoNameTextView.setText(repo.title);
                repoDescriptionTextView.setText(repo.overview);
                forksTextView.setText("33232");
                starsTextView.setText("323232");
            }
        });
    }
}
